        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="https://www.linkedin.com/in/abhimanyu-mallik/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 font-sans text-sm text-white/50 hover:text-[#C9A84C] transition-colors">
                  <Linkedin size={16} className="shrink-0" />
                  <span>Abhimanyu Mallik <span className="text-white/30">— Founder</span></span>
                </a>
              </li>
              <li>
                <a href="mailto:info@abhiarafoundation.org" className="flex items-center gap-3 font-sans text-sm text-white/50 hover:text-[#C9A84C] transition-colors">
              ...
              <li>
                <a href="https://wa.me/919938938321" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 font-sans text-sm text-white/50 hover:text-[#25D366] transition-colors">
