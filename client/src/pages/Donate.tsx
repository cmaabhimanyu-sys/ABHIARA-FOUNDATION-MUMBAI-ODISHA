          ...
          <div className="bg-white/5 border border-[#C9A84C]/30 rounded-2xl p-8 mb-8 text-left">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-[#25D366] hover:bg-[#1DA851] text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 w-full max-w-sm justify-center"
              >
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 bg-[#0A1628]">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          ...
          <p className="text-white/70 text-base leading-relaxed mb-12 max-w-2xl mx-auto">
            Every person who contributes to Abhiara Foundation is honoured here — permanently and publicly. Because generosity deserves to be seen. Because every name on this wall represents a life changed.
          </p>
          ...
          <div className="bg-[#C9A84C]/10 border border-[#C9A84C]/30 rounded-2xl p-8 mb-10">
            <p className="text-[#C9A84C] text-xs uppercase tracking-widest mb-4">How to Join the Wall of Light</p>
          ...
          <div className="text-center mb-8">
            <p className="text-white/30 text-xs leading-relaxed max-w-xl mx-auto">
              Names are only displayed with explicit permission of the donor. Anonymous donations are honoured as "A Friend of Abhiara" on the wall. No financial amounts are ever displayed publicly.
            </p>
          </div>
