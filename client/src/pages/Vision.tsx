          ...
          <div className="max-w-3xl mx-auto">
            {[
              ...
              },
              {
                ...
                icon: Users,
                items: [
                  "Expand to all districts of Odisha",
                  "Build corpus for Abhiara Vidyapeeth",
                  "Grow CSR partnerships — ₹50L+ target",
                  "1,000+ students in scholarship programmes",
                  "Quarterly health camps across 5+ districts",
                ],
                active: false,
              },
              {
