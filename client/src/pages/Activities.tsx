...
const FALLBACK_BLOG: BlogPostItem[] = [
  {
    ...
    content: [
      "In March 2026, the Abhiara Foundation team visited Hope is Life Old Age Home in Puri, Odisha — our first formal elderly care outreach. What began as a planned visit quickly became an emotional experience that reinforced why this work matters.",
  ...
  },
  {
    ...
    content: [
      "In March 2026, the Abhiara Foundation team travelled to Kendrapara district in Odisha to distribute books and educational materials to tribal children in underserved communities.",
