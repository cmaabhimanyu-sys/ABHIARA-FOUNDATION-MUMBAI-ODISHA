/*
 * Abhiara Foundation — Our Story V3.0
 * Sections: Hero, Name Meaning, Founding Narrative (7 chapters), Google Maps, Governance, CTA
 */
        ...
        <div className="container max-w-3xl">
          ...
          <div className="space-y-8">
            {[
              ...
              {
                label: "",
                text: "That is not a dream. That is a deadline.",
                highlight: true,
              },
              {
                label: "The Scale",
          ...
          <AnimatedSection delay={0.15} className="mt-12 mb-8">
            <div className="text-center mt-12 mb-8">
              ...
              <p className="text-white/70 text-lg leading-relaxed italic">
                Rooted in the sacred land of Odisha. Built for every child. Built for every elder. Regardless of community, religion, or background.
              </p>
            </div>
          </AnimatedSection>
